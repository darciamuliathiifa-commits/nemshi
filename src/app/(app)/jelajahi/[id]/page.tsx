        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.6fr_1fr]">
            <div className="flex flex-col gap-6">
              <div
                className={`flex h-64 items-start justify-between rounded-card border-[2.5px] border-ink bg-gradient-to-br px-6 py-5 shadow-[3px_3px_0_0_rgba(20,20,20,1)] ${categoryAccent[ad.category]}`}
              >
