...
export default function NotFound() {
  return (
    <main className="flex flex-col items-center justify-center gap-4 bg-gradient-to-b from-surface-tint to-white px-4 py-24 text-center">
      <span className="flex h-14 w-14 items-center justify-center bg-primary text-2xl font-bold text-white">
        N
      </span>
      ...
      <Link
        href="/"
        className="mt-2 bg-primary px-6 py-2.5 text-sm font-semibold text-white transition-transform hover:scale-[1.02]"
      >
        Kembali ke Beranda
      </Link>
    </main>
