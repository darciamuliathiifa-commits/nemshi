...
Terima kasih banyak sebelumnya sidi 🙏`,
  },
  {
    ...
    body: `Woy [nama], gue lagi bantuin bangun portal kecil buat Masisir namanya Nemsyi — tempat jual/cari barang, jasa, sama sayembara minta bantuan, biar nggak keubur di grup WA. Lagi tahap awal, gue butuh isi etalase-nya dulu. Lo ada barang/jasa yang mau dipasang nggak? 2 menit doang, gratis, dan lo bakal jadi salah satu yang pertama muncul pas orang buka Nemsyi. Gas bantu? https://nemsyi.sbs`,
  },
  {
    id: "kenalan",
    title: "Ajak kenalan / kakak tingkat",
    description: "Sedikit lebih formal, buat yang belum terlalu deket.",
    body: `Assalamualaikum kak/bang, izin promosi bentar — lagi bangun portal kecil buat komunitas Masisir namanya Nemsyi, isinya jual-beli barang, jasa, sama sayembara (minta bantuan) biar nggak nyari-nyari lagi di grup WA yang udah penuh. Sekarang lagi tahap ngisi etalase pembukaan, dan kebetulan kakak sering [jual buku/jasa desain/dll] — kalau berkenan pasang 1 iklan aja, gratis, dan bakal ikut ditampilin di etalase pembukaan. Linknya: https://nemsyi.sbs. Makasih banyak kak!`,
  },
  {
    id: "mau-pulang",
