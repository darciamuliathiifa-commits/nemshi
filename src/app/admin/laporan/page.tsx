              ...
              {suspendingId === report.id && (
                <div className="mt-3 rounded-2xl bg-white p-3">
                  <textarea
                    ...
                    className="mb-2 w-full resize-none rounded-lg border border-black/10 px-3 py-2 text-sm text-text outline-none focus:border-accent focus:ring-4 focus:ring-accent/10"
                  />
