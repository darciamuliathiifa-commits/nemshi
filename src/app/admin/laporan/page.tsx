    ...
    <div className="bg-white p-6 border border-black/10 sm:p-8">
      ...
      {!reports ? (
        ...
        <div className="flex flex-col gap-3">
          {reports.map((report) => (
            <div key={report.id} className="bg-surface p-4">
              ...
              {suspendingId === report.id && (
                <div className="mt-3 bg-white p-3">
                  <textarea
                    ...
                    className="mb-2 w-full resize-none border border-black/10 px-3 py-2 text-sm text-text outline-none focus:border-accent"
                  />
